...
namespace H05.BUSINESS.Common
{
        ...
        where TFilterDto : class
    {
        ...
        public virtual async Task<PagedResponseDto> Search(Filter<TFilterDto> filter)
        {
            try
            {
        ...
        public virtual async Task<PagedResponseDto> Paging(IQueryable<TEntity> query, Filter<TFilterDto> filter)
        {
            try
            {
