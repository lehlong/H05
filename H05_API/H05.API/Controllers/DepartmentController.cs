...
namespace H05.API.Controllers
{
    ...
    {
        public readonly IDepartmentService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] DepartmentDto time)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] DepartmentDto time)
        {
            var transferObject = new TransferObject();
