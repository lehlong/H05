...
namespace H05.API.Controllers.MD
{
    ...
    [ApiController]
    public class OrderTypeController(IOrderTypeService service) : ControllerBase
    {
        public readonly IOrderTypeService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] OrderTypeDto time)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] OrderTypeDto time)
        {
            var transferObject = new TransferObject();
