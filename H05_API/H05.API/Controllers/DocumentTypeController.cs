...
namespace H05.API.Controllers
{
    ...
    {
        public readonly IDocumentTypeService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] DocumentTypeDto dto)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] DocumentTypeDto dto)
        {
            var transferObject = new TransferObject();
