...
namespace H05.API.Controllers
{
    ...
    {
        public readonly IMenuItemService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] MenuItemDto dto)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] MenuItemDto dto)
        {
            var transferObject = new TransferObject();
