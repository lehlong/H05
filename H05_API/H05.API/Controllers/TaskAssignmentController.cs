...
namespace H05.API.Controllers
{
    ...
    {
        public readonly ITaskAssignmentService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] TaskAssignmentDto dto)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] TaskAssignmentDto dto)
        {
            var transferObject = new TransferObject();
