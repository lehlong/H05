...
namespace H05.API.Controllers
{
    ...
    {
        public readonly IBusinessUnitService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] BusinessUnitDto dto)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] BusinessUnitDto dto)
        {
            var transferObject = new TransferObject();
